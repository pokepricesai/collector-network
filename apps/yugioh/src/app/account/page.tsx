      ...
      <main className={styles.page}>
        ...
        <div className={styles.grid}>
          <Link href="/collection" className={styles.tile}>
            ...
            <span className={styles.tileTag}>Coming in Slice D</span>
          </Link>
          <Link href="/watchlist" className={styles.tile}>
            <h2 className={styles.tileTitle}>Watchlist</h2>
            <p className={styles.tileMeta}>
              Follow cards you don&apos;t yet own. Prices and movement in one view.
            </p>
            <span className={styles.tileTag}>Coming in Slice E</span>
          </Link>
